...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0016_remove_question_quiz_remove_quiz_lesson_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_unit', to='courses.unit')),
            ],
        ),
        migrations.AddField(
            model_name='question',
